		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Desarrollo SAPUI5",
									"targetURL": "#ui5samplecoreelements-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5samplecoreelements-display": {
								"semanticObject": "ui5samplecoreelements",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.samplecoreelements",
									"url": sap.ui.require.toUrl("ui5/samplecoreelements")
								}
							}
						}
					}
